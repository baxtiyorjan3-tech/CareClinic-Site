...
// this function wil create frontend url
...
export const getAppointmentsByPatient = async (req, res) => {
  try {
    ...
    if (re.query.mobile) filter.mobile = req.query.mobile;
...
// to confirm the onlone payment and make it paid
...
export const getStats = async (req, res) => {
  try {
    ...
    console.error("getStatst error", err);
    return res.status(500).json({ success: false, message: "Server error" });
  }
};
