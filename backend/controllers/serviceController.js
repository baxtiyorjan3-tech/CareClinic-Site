// helpers functions
// so this funtion converts array like input into a Clean array
...
// So this function takes date-time slot strings and group them in a
...
export async function createService(req, res) {
  try {
    ...
    console.err("createServiceError", err);
...
export async function getServices(req, res) {
  try {
    ...
    console.err("getServiceError", err);
    return res.status(500).json({
      success: false,
      message: "server Error",
    });
...
export async function getServiceById(req, res) {
  try {
    ...
    console.err("getServiceByIdError", err);
    return res.status(500).json({
      success: false,
      message: "server Error",
    });
...
export async function deleteService(req, res) {
  try {
    ...
    console.err("deleteService Error", err);
    return res.status(500).json({
      success: false,
      message: "server Error",
    });
