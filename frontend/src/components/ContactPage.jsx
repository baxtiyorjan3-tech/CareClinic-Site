    ...
    <div className={contactPageStyles.pageContainer}>
      ...
      <div className={contactPageStyles.gridContainer}>
            ...
            <div className={contactPageStyles.buttonContainer}>
              ...
              {sent && (
                <p className={contactPageStyles.sentMessage}>
                  Opening Whatsappp and cleatinf form...{" "}
                </p>
              )}
            </div>
          </form>
        ...
        <div className={contactPageStyles.infoContainer}>
          ...
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d6002.210664872929!2d69.30325299999997!3d41.219474999999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2s!4v1780985337051!5m2!1sen!2s"
